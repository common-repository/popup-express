...
Popup for Aweber, Mailchimp, or custom url

With Popup Express pro you can create a popup that will work with Aweber, Mailchimp or a custom url.  Now you can use your favorite email management company with your popup form.  Choose Aweber and enter your list name for the popup to send subscribers to your Aweber account.  Choose Mailchimp and put in your Mailchimp url for the popup to send subscribers to your Mailchimp account.  Choose custom and enter a url where you want the popup to send the subscribers information.  Controlling where you send subscribers from your popup form has never been easier.

Popup lightbox on your post

Popup Express Pro gives you the ability to turn popups on and off for all of your post.

Popup lightbox on your pages

Popup Express Pro gives you the ability to turn popups on and off for all of your pages.
...
No.  The popup plugin does the programming and design. No html coding is required to make your popup work.
...
The pro version has an exit intent popup.  It determines the user's intent on exiting the page and pops the popup at just the right time. You can also control how often the exit intent popup shows.
...
= Can I show the popup on post? =
Yes, you can control the popup popping on post in the upgraded pro version.  You can toggle the popup on and off for all post.


== Screenshots ==

[See screenshots at thinklandingpages.com] (http://www.thinklandingpages.com/popup-express-quickY-start/)
